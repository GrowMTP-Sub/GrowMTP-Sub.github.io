...
function chartFallback(selector, page, figures) {
  $$(selector).forEach((node) => {
    node.innerHTML = `<p class="rq1-chart-fallback">Curve data did not load. <a href="assets/GrowMTP_Submission.pdf#page=${page}" target="_blank" rel="noopener">View ${figures} ↗</a></p>`;
  });
}
